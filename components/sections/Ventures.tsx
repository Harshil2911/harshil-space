...
export const VENTURES = [
  {
    ...
    description: 'We automate what holds businesses back. Workcin wires AI into the backbone of your operations — from lead workflows to internal systems.',
    stats: [
  ...
  },
  {
    ...
    description: 'A next-generation placement platform connecting top talent with the right opportunities through intelligent matching systems.',
    stats: [
  ...
  },
  {
    ...
    description: 'A startup laboratory where ambitious ideas get stress-tested, validated, and turned into market-ready products.',
    stats: [
  ...
  },
  {
    ...
    description: 'Building resilient digital infrastructure and security systems that protect businesses from threats they haven\'t anticipated yet.',
    stats: [
